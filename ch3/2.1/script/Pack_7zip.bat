...
for %%a in (%bat_dir%) do set cur_dir=%%~nxa
echo %cur_dir%

mkdir "_bak"

set zipname="./_bak/%cur_dir%_bak%date:~0,4%%date:~5,2%%date:~8,2%_%time:~0,2%%time:~3,2%.zip"
...
D:\7-Zip\7z.exe a -tzip %zipname% -xr!*bak*.*
